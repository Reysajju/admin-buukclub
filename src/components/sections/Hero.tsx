...
const PERSONA_COPY = {
    author: {
        badge: "For Visionary Authors",
        headline: "The Author's Ultimate Window to Loyal Readers",
        description:
            "Host intimate live sessions where every assigned reader becomes a lifelong fan you actually own. No algorithms, no middle-men—just a direct window to your tribe.",
        talkingPoints: [
        ...
        stats: [
            { label: "Assigned Audience / $200", value: "150+" },
                    ...
                    <div className="inline-flex p-1 rounded-full bg-background/80 border border-border font-medium text-sm">
                        {(Object.keys(PERSONA_COPY) as Persona[]).map((key) => (
                            <button
                                ...
                                className={`px-4 py-2 rounded-full transition-all ${persona === key
