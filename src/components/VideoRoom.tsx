...
import '@livekit/components-styles'; import TranscriptionManager from './TranscriptionManager';
...
export default function VideoRoom({
    ...
    return (
        <div className="w-full h-full relative group bg-black">
            <LiveKitRoom
                video={isPublisher} // Strictly only host can publish
                audio={isPublisher} // Strictly only host can publish
                token={token}
