// Font fetch skipped to prevent build timeout. Relying on default sans/serif or adding links later.
import "./globals.css";
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body
        className={`antialiased bg-background text-foreground paper-texture overflow-x-hidden`}
      >
        <script
